...
import com.cumulocity.sdk.agent.action.ObtainDeviceMeasurementsAction.DeviceMeasurementsRetriever;
 ...
 */
public class MpsDeviceMeasurementsRetriever implements DeviceMeasurementsRetriever<MpsDevice> {
	...
	@Override
	public List<MeasurementRepresentation> loadMeasuremntsFromDevice(MpsDevice device) {
