...
import com.cumulocity.snmp.service.gateway.PlatformSubscriber;
...
public class PlatformSubscriberTest {
    ...
    public void shouldTestGatewayAddedEvent() {
        ...
        when(notifications.subscribeOperations(eq(platformParameters), eq(gateway.getId()), any(OperationListener.class))).thenReturn(operationNotificationSubscriber);
