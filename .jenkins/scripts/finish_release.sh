...
git pull https://${REPOSITORY_USER}:${REPOSITORY_PASSWORD}@${REPOSITORY_BASE_URL}/cumulocity-examples
...
git push https://${REPOSITORY_USER}:${REPOSITORY_PASSWORD}@${REPOSITORY_BASE_URL}/cumulocity-examples develop
