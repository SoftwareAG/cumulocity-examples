...
git pull ${REPOSITORY_BASE_URL}/cumulocity-examples ${branch_name}
...
git push ${REPOSITORY_BASE_URL}/cumulocity-examples ${branch_name}
git push ${REPOSITORY_BASE_URL}/cumulocity-examples ${tag}
